...
# ══════════════════════════════════════════════════════════════════════════════
# ENGINE 3b: ACTIVE IP DISCOVERY — Correlation Attack
# ══════════════════════════════════════════════════════════════════════════════

# ── CDN / shared hosting ranges that should NOT be attributed to operator ──
_CDN_ASNS = {
    "cloudflare", "akamai", "fastly", "amazon", "google", "microsoft",
    "cdn77", "stackpath", "bunnycdn", "jquery", "bootstrap", "cdnjs",
}
